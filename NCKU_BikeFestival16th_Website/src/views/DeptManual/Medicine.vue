  ...
  <div>
    ...
    <div class="flex mx-12 h-[1300px] max-xl:mx-0 max-xl:flex-col max-xl:h-[1500px] max-sm:h-[1100px]">
      ...
      <div class="relative flex flex-col mr-20 mt-20 w-[500px] bg-black text-white text-center max-xl:mt-0 max-xl:w-screen xl:h-[1000px]">
        <!-- RWD -->
        <div @click="show" class="absolute bg-black w-screen h-[50px] text-2xl font-bold xl:hidden">醫學院</div>
        ...
        >
          ...
          <div class="memberInfo">
            <!-- <picture> -->
              ...
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Medicine/Medicine1.jpg" alt="member">
            <!-- </picture> -->
          ...
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto object-cover max-h-[244px] mt-5 max-sm:max-h-[180px]" src="../../assets/DeptManual/Medicine/Medicine2.JPG" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">王晨彬</span>
            <span class="fontSize mt-3 text-center">藥學系 115</span>
            <span class="fontSize mt-2 text-center">#進入藥學系後，我發現自己竟然有不睡覺的能力！</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Medicine/Medicine3.PNG" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">蔡崇德</span>
            <span class="fontSize mt-3 text-center">醫學系 115</span>
            <span class="fontSize mt-2 text-center">#醫學電機雙主修的超人</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Medicine/Medicine4.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">方文廷</span>
            <span class="fontSize mt-3 text-center">醫學檢驗生物技術學系 113</span>
            <span class="fontSize mt-2 text-center">#斜槓到不能再斜了</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Medicine/Medicine5.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">黃芮澤</span>
            <span class="fontSize mt-3 text-center">職能治療學系 114</span>
            <span class="fontSize mt-2 text-center">#多多嘗試，多多學習，活出自己的人生！</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Medicine/Medicine6.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">趙珮辰</span>
            <span class="fontSize mt-3 text-center">物理治療學系 113</span>
            <span class="fontSize mt-2 text-center">#想清楚自己想要什麼、喜歡什麼</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] object-cover max-h-[244px] mx-auto mt-5 max-sm:max-h-[180px]" src="../../assets/DeptManual/Medicine/Medicine7.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">黃友誠</span>
            <span class="fontSize mt-3 text-center">牙醫學系 117</span>
            <span class="fontSize mt-2 text-center">#善於時間管理的未來牙醫</span>
          </div>
        </div>
      </div>
