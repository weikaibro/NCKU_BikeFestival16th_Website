...
import ComputerScienceandInformationEngineering from "./ElectricalEngineeringAndComputerScienceManual/ComputerScienceandInformationEngineering.vue"
import ElectricalEngineering from './ElectricalEngineeringAndComputerScienceManual/ElectricalEngineering.vue'
...
const showContent = computed(() => {
  switch (userChosenNum.value) {
    case 0: return ComputerScienceandInformationEngineering;
    case 1: return ElectricalEngineering;
    default: break;
  }
});
  ...
  <div>
    ...
    <div class="flex mx-12 mt-20 h-[1300px] max-xl:mx-0 max-xl:flex-col max-xl:h-[1500px] max-sm:h-[1100px]">
      ...
      <div class="relative flex flex-col mr-20 mt-20 w-[500px] bg-black text-white text-center max-xl:mt-0 max-xl:w-screen xl:h-[1000px]">
        <!-- RWD -->
        <div @click="show" class="absolute bg-black w-screen h-[50px] text-2xl font-bold xl:hidden">電資學院</div>
        ...
        <!-- Laptop -->
        <div class="text-3xl mt-10 mb-6 font-bold max-xl:hidden">電資學院</div>
    ...
    <div class="mt-16 w-screen px-2">
      ...
      <div class="flex justify-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/uc5sQF0dadM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="relative mt-60 p-0 w-screen h-[800px]">
      ...
      >
        ...
        >
          <RouterLink to="/DeptManual/ElectricalEngineeringAndComputerScience/member1">
            <div class="memberInfo">
              <!-- <picture> -->
                <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
                <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/ElectricalEngineeringAndComputerScience/ElectricalEngineeringAndComputerScience1.jpg" alt="member">
              <!-- </picture> -->
              <span class="mt-10 text-3xl font-bold max-md:mt-6">姚磊漢</span>
              <span class="fontSize mt-3 text-center">電機工程學系 114</span>
              <span class="fontSize mt-2 text-center">#樂觀社牛活動電神</span>
            </div>
          </RouterLink>
          <RouterLink to="/DeptManual/ElectricalEngineeringAndComputerScience/member2">
            <div class="memberInfo">
              <!-- <picture> -->
                <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              ...
              <span class="fontSize mt-2 text-center">#用盡一切資源精進自己</span>
            </div>
          </RouterLink>
