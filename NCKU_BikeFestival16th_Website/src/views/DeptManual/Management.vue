  ...
  <div>
    ...
    <div class="flex mx-12 h-[1300px] max-xl:mx-0 max-xl:flex-col max-xl:h-[1500px] max-sm:h-[1100px]">
      ...
      <div class="relative flex flex-col mr-20 mt-20 w-[500px] bg-black text-white text-center max-xl:mt-0 max-xl:w-screen xl:h-[550px]">
        <!-- RWD -->
        <div @click="show" class="absolute bg-black w-screen h-[50px] text-2xl font-bold xl:hidden">管理學院</div>
        ...
        >
          ...
          <div class="memberInfo">
            <!-- <picture> -->
              ...
              <img class="rounded-full w-[80%] min-h-[244px] mx-auto mt-5 max-sm:min-h-[180px]" src="../../assets/DeptManual/Management/Management1.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">張芸菁</span>
            <span class="fontSize mt-3 text-center">會計學系 114</span>
            <span class="fontSize mt-2 text-center">#求工作穩定選會計系就對啦</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Management/Management2.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">陳芊妤</span>
            <span class="fontSize mt-3 text-center">統計系 114</span>
            <span class="fontSize mt-2 text-center">#從體驗成大生活到進入成大生活</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Management/Management3.JPG" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">劉彥妮</span>
            <span class="fontSize mt-3 text-center">企業管理學系 114</span>
            <span class="fontSize mt-2 text-center">#在大學勇敢追求興趣，活出屬於自己的精彩</span>
          </div>
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] mx-auto mt-5" src="../../assets/DeptManual/Management/Management4.jpg" alt="member">
            <!-- </picture> -->
          ...
          <div class="memberInfo">
            <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img class="rounded-full w-[80%] min-h-[244px] object-cover mx-auto mt-5 max-sm:min-h-[180px]" src="../../assets/DeptManual/Management/Management5.jpg" alt="member">
            <!-- </picture> -->
            <span class="mt-10 text-3xl font-bold max-md:mt-6">王振崎</span>
            <span class="fontSize mt-3 text-center">工業與資訊管理學系 113</span>
            <span class="fontSize mt-2 text-center">#每個人的時區都不同，相信自己會發光就會發光</span>
          </div>
