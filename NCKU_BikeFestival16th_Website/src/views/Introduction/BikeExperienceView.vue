...
<template>
  <div class="h-screen bg-black overflow-hidden">
    ...
    >
      <div class="text-3xl font-bold">單車體驗</div>
      <br />
      漫步在充滿歷史風華的成大校園，隨處可見一輛輛腳踏車在校園兩道旁。單車，是成大學子必備的交通工具。學生們辛勤地踩踏著，只為奔向無窮無盡的學識。為讓參與者體驗成大生的日常，同時認識成大的環境與歷史古蹟蘊含的人文底蘊，我們規劃了數條校園巡禮路線，帶你遊成大！
      <br /><br />
      單車導覽：
      <br />
      共分三條導覽路線－「文學院的一天」、「觀光客行程」、「理工之旅」在每一條路線中，都將由我們為您沿途做解說，讓你深入了解成大景點與其歷史背景，以及不為人知的稗官野史。過程中，更穿插有趣味的問答，運氣好的話，搞不好還能拿到精美小禮物喔！
      <br /><br />
      <span class="fontEff">文學院的一天</span>
      <br />
      中正堂 → 榕園 → 家寶醫學研究室 → 台文系 → 歷史文物館 → 小西門 → 火車頭 → 中正堂
      <br /><br />
      <span class="fontEff">觀光客行程</span>
      <br />
      中正堂 → 博物館 → 格致堂 → 總圖 → 小西門（歷史文物館）→ 榕園 → 中正堂 
      <br /><br />
      <span class="fontEff">理工之旅</span>
      <br />
      中正堂 → 測量系館 → 自強校區 → 航太系直升機 → 未來館 → 格致堂 → 中正堂
      <br /><br />
