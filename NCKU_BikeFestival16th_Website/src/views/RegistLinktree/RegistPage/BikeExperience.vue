...
const Liberal = [
  "3/4(六) 13:00-13:50", "3/5(日) 9:00-9:50", "3/5(日) 13:00-13:50"
]
const Tourist = [
  "3/4(六) 10:00-10:50", "3/4(六) 15:00-15:50", "3/5(日) 11:00-11:50", "3/5(日) 15:00-15:50"
]
const Fragrant = [
  "3/4(六) 11:00-11:50", "3/4(六) 14:00-14:50", "3/5(日) 10:00-10:50", "3/5(日) 14:00-14:50"
]
const num = ref(5);
const Switch = (index) => {
  num.value = index;
...
<template>
  <div class="bg-black text-white">
    ...
    <div class="flex flex-col justify-center items-center gap-16 mt-10 max-md:gap-10">
      <span class="text-5xl font-bold tracking-wider max-md:text-4xl">單車體驗</span>
      <picture>
      ...
      <div class="px-36 pt-16 max-md:px-4">
        <div>
          ...
          <div class="text-lg leading-9 max-sm:text-sm">
            單車體驗共分三條導覽路線 ——「文學院的一天」、「觀光客行程」、「香香之旅」。
            <br /><br />
            <span class="text-2xl max-md:text-lg">文學院的一天 (約50分)</span>
            <br> 中正堂 → 榕園 → 家寶醫學研究室 → 台文系 → 歷史文物館 → 小西門 → 火車頭 → 中正堂
            <br /><br />
            <span class="text-2xl max-md:text-lg">觀光客行程 (約50分)</span>
            <br> 中正堂 → 博物館 → 格致堂 → 總圖 → 榕園 → 小西門/歷史文物館 → 中正堂
            <br><br>
            <span class="text-2xl max-md:text-lg">香香之旅 (約50分)</span>
            <br> 中正堂 → 測量系 → 自強校區 → 航太系直升機 → 格致堂 → 未來館 → 中正堂 
            <br><br>
            ＊單車體驗每團限額七人，有興趣參與者記得到報名專區報名喔！每團每時段以報名前七人優先錄取，屆時名單將公布在單車節臉書～
            <br> ＊如對以上內容有任何疑惑，歡迎私訊「成大單車節」臉書粉專或 IG 官方帳號
            <br> ＊若當日該時段遇到下雨，則該時段的單車導覽取消～
            <br> ＊報名截止日為 2/22 23:59
            <br><br>
          </div>
          ...
          <div>
            ...
            <form
              action="https://nckubikefestival.ncku.edu.tw/api/register/BikeExperience"
              method="POST"
            ...
            >
              ...
              <div class="mt-12">
                <p class="text-lg mt-6 after:content-['*'] after:ml-0.5 after:text-red-500">身份證字號 </p>
              ...
              <div class="mt-12">
                <p class="text-lg my-6 after:content-['*'] after:ml-0.5 after:text-red-500">目前就讀學校 </p>
                <input
                  name="school"
                  class="inputEff"
                  type="text"
                ...
                <Transition mode="out-in">
                  <div v-if="num == 0">
                    <div class="text-lg my-6">
                      ...
                      <br> 中正堂 → 榕園 → 家寶醫學研究室 → 台文系 → 歷史文物館 → 小西門 → 火車頭 → 中正堂 (約50分)
                    </div>
                    <div class="text-lg my-6 after:content-['*'] after:ml-0.5 after:text-red-500">選擇想要的梯次吧！</div>
                    <div 
                  ...
                  <div v-else-if="num == 1">
                    <div class="text-lg my-6">
                      ...
                      <br> 中正堂 → 博物館 → 格致堂 → 總圖 → 榕園 → 小西門/歷史文物館 → 中正堂 (約50分)
                    </div>
                    <div class="text-lg my-6 after:content-['*'] after:ml-0.5 after:text-red-500">選擇想要的梯次吧！</div>
                    <div 
                  ...
                  <div v-else-if="num == 2">
                    <div class="text-lg my-6">
                      ...
                      <br> 中正堂 → 測量系 → 自強校區 → 航太系直升機→格致堂 → 未來館 → 中正堂 (約50分)  
                    </div>
                    <div class="text-lg my-6 after:content-['*'] after:ml-0.5 after:text-red-500">選擇想要的梯次吧！</div>
                    <div 
