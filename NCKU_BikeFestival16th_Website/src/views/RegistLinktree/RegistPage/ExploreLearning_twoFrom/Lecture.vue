    ...
    <div class="hidden">
      <div>
        <iframe name="formIframe" class="hidden"></iframe>
          <form
            action="/api/register/ExploreLearning"
            method="POST"
          ...
          <div class="mt-20 text-lg leading-9 max-sm:text-sm">
            ...
            <div>我們需要收集您的基本資料，以方便跟您進行有效的報名確認和聯絡。</div>
          </div>
          ...
          <div class="mt-12">
            <p class="text-lg my-6 after:content-['*'] after:ml-0.5 after:text-red-500">連絡電話 </p>
            <input
              name="phone"
              class="inputEff"
              type="text"
          ...
          <div class="mt-20">
            <div class="text-3xl">B. ✨講座參與意願✨</div>
            <div class="text-lg">
            <div class="text-2xl mt-12 mb-2">場次一 03／04（六）10：00 ~11：30（9:30開放入場）</div>
            主題：擊敗拖延｜事半功倍的高效學習法
            <br> 講師：莊愛玲
            <br> 組織：爆學力  
            <br> 地點：國際會議廳一
            <div class="text-2xl mt-12 mb-2">場次二 03／04（六）13：30 ~15：00（13:00開放入場）</div>
            主題：讓服務學習時數用在真正需要的地方，志工活動也可以很有趣
            <br> 講師：黃妍庭 
            <br> 組織：善耕365公益媒合平台  
            <br> 地點：國際會議廳一
            <div class="text-2xl mt-12 mb-2">場次三 03／04（六）16：00 ~17：30（15:30開放入場）</div>
            主題：船到橋頭自然直－成為法律人的心理準備
            <br>  講師：江鎬佑
            <br> 組織：法律白話文運動
            <br> 地點：國際會議廳一
            <div class="text-2xl mt-12 mb-2">場次四 03／05（日）10：00 ~11：30（9:30開放入場）</div>
            主題：如何系統化探索大學科系，一起來「做中學」
            <br> 講師：許匡毅
            <br> 組織：啟夢教育  
            <br> 地點：國際會議廳一
            <div class="text-2xl mt-12 mb-2">場次五 03／05（日）13：30 ~15：00（13:00開放入場）</div>
            主題：先有人，才有教育
            <br> 講師：白承修
            <br> 組織：Teach For Taiwan為台灣而教
            <br> 地點：國際會議廳一    
            <br><br> PS：請各位提前15~30分鐘入場，謝謝配合。
            </div>
          </div>

          <div class="mt-12">
            <p class="mb-4 text-2xl after:content-['*'] after:ml-0.5 after:text-red-500">欲報名之場次（可複選喔） </p>
            <label
              class="checkBoxEff"
          ...
          <div class="mt-12 text-lg">
            ...
            <div class="mb-6">
              為什麼會想來聽這些講座？
              <br> 關於特定主題，有沒有什麼內容是希望講師能在分享中提到，或是有沒有問題是替你解惑的？
              <br> 只需填寫欲報名之場次即可
              <br> 註：因為場地有人數限制，所以若報名人數過多，會依填寫內容擇優錄取
            </div>
          </div>
          <div class="mt-12 text-lg">
            <div class="text-xl">【場次一、擊敗拖延｜事半功倍的高效學習法】請填寫報名動機及相關疑問</div>
          ...
          <div class="mt-12 text-lg">
            <div class="text-xl">【場次二、 讓服務學習時數用在真正需要的地方，志工活動也可以很有趣】請填寫報名動機及相關疑問</div>
            <div class="mb-6">PS：請認真填寫喔！</div>
            <input
              name="session2"
              class="inputEff"
          ...
          <div class="mt-12 text-lg">
            <div class="text-xl">【場次三、 船到橋頭自然直－成為法律人的心理準備】請填寫報名動機及相關疑問</div>
            <div class="mb-6">PS：請認真填寫喔！</div>
            <input
              name="session3"
              class="inputEff"
          ...
          <div class="mt-12 text-lg">
            <div class="text-xl">【場次四、 如何系統化探索大學科系，一起來「做中學」】請填寫報名動機及相關疑問</div>
            <div class="mb-6">PS：請認真填寫喔！</div>
            <input
              name="session4"
              class="inputEff"
          ...
          <div class="mt-12 text-lg">
            <div class="text-xl">【場次五、 先有人，才有教育】請填寫報名動機及相關疑問</div>
            <div class="mb-6">PS：請認真填寫喔！</div>
            <input
              name="session5"
              class="inputEff"
          ...
          <div class="mt-12 text-lg">
            <div class="text-xl my-6">感謝你/妳填寫這份表單，有任何想說的話都可以在這邊跟我們說！</div>
            <input
              name="anything"
              class="inputEff"
              type="text"
