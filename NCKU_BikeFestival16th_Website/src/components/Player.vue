...
<template>
  ...
  <div class="bg-black h-screen overflow-hidden">
    ...
    >
      ...
      1. 動態校園講者：
      <br />
      在單車節活動兩日，舉辦共計 19 場的精彩演講，主題從多元經驗、課業經驗、生活經驗、人際關係到其他特殊主題分享應有盡有，讓充滿好奇與疑惑的你，面對面聆聽學長姐的經驗談，以最直接的方式一探大學生活究竟。在演講結束後，也設有問答時間，讓學長姐們直接答覆你的疑問！
      <br /><br />
      2. 大學甘苦談：
      <br />
      蒐集並彙整講者們經驗，以靜態展覽的形式呈現。聽過演講的你，能夠再重新回味方才的精華；等待演講中的你，可先概覽講者小檔案；還在猶豫參加哪場演講的你，可以透過個人展鎖定適合自己的場次喔！
      <br /><br />
      3. 線上 Podcast：
      <br />
      ...
      <br />
      地點：校園講者與大學甘苦談將在光復校區統計系館舉行 <br /><br>
