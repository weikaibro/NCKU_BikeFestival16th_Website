...
import BiotechnologyandBioindustrySciences from './BioscienceAndBiotechnologyManual/BiotechnologyandBioindustrySciences.vue';
import LifeSciences from './BioscienceAndBiotechnologyManual/LifeSciences.vue';
...
const showContent = computed(() => {
  switch (userChosenNum.value) {
    case 0: return BiotechnologyandBioindustrySciences;
    case 1: return LifeSciences;
    default: break;
  }
});
  ...
  <div>
    ...
    <div class="flex mx-12 mt-20 h-[1300px] max-xl:mx-0 max-xl:flex-col max-xl:h-[1500px] max-sm:h-[1100px]">
      ...
      <div class="relative flex flex-col mr-20 mt-20 w-[500px] bg-black text-white text-center max-xl:mt-0 max-xl:w-screen xl:h-[1000px]">
        <!-- RWD -->
        <div @click="show" class="absolute bg-black w-screen h-[50px] text-2xl font-bold xl:hidden">生技學院</div>
        ...
        <!-- Laptop -->
        <div class="text-3xl mt-10 mb-6 font-bold max-xl:hidden">生技學院</div>
    ...
    <div class="mt-16 w-screen px-2">
      ...
      <div class="flex justify-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/aj_PWisYeDg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
