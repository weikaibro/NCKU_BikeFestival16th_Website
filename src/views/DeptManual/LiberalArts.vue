  ...
  <div>
    ...
    <div class="mt-16 w-screen px-2">
      ...
      <div class="flex justify-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/lNL8eVVH0wg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="relative mt-60 p-0 w-screen h-[800px]">
      ...
      >
        ...
        >
          <RouterLink to="/DeptManual/LiberalArts/member1">
            <div class="memberInfo">
              ...
              <img
                ...
                src="../../assets/DeptManual/LiberalArts/LiberalArts1.jpg"
                alt="member"
              />
              <!-- </picture> -->
              <span class="mt-10 text-3xl font-bold max-md:mt-6">柯睿信</span>
              <span class="fontSize mt-3 text-center">歷史學系 115</span>
              <span class="fontSize mt-2 text-center">#特殊選材的奇人</span>
            </div>
          </RouterLink>
          <RouterLink to="/DeptManual/LiberalArts/member2">
            <div class="memberInfo">
              <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img
                class="rounded-full w-[80%] min-h-[244px] object-cover mx-auto mt-5 max-sm:min-h-[180px]"
                src="../../assets/DeptManual/LiberalArts/LiberalArts2.png"
                alt="member"
              />
              <!-- </picture> -->
              <span class="mt-10 text-3xl font-bold max-md:mt-6">方筱睎</span>
              <span class="fontSize mt-3 text-center">外國語文學系 114</span>
              <span class="fontSize mt-2 text-center">#文學，一切都是文學</span>
            </div>
          </RouterLink>
          <RouterLink to="/DeptManual/LiberalArts/member3">
            <div class="memberInfo">
              <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img
                class="rounded-full w-[80%] mx-auto mt-5"
                src="../../assets/DeptManual/LiberalArts/LiberalArts3.png"
                alt="member"
              />
              <!-- </picture> -->
              <span class="mt-10 text-3xl font-bold max-md:mt-6">李家豪</span>
              <span class="fontSize mt-3 text-center">台灣文學系 115</span>
              <span class="fontSize mt-2 text-center">#台文的斜槓人才</span>
            </div>
          </RouterLink>
          <RouterLink to="/DeptManual/LiberalArts/member4">
            <div class="memberInfo">
              <!-- <picture> -->
              <!-- <source class="rounded-full w-[80%] mx-auto mt-5 max-md:mt-1" srcset="" type="image/webp"> -->
              <img
                class="rounded-full w-[80%] mx-auto mt-5"
                src="../../assets/DeptManual/LiberalArts/LiberalArts4.jpg"
                alt="member"
              />
              <!-- </picture> -->
              <span class="mt-10 text-3xl font-bold max-md:mt-6">張雅筑</span>
              <span class="fontSize mt-3 text-center">中國文學系 113</span>
